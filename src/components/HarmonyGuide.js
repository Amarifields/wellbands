...
const ResetPortal = () => {
  ...
  return (
    <div
      className={`bg-black text-white overflow-x-hidden w-full transition-opacity duration-1000 ${
        isVisible ? "opacity-100" : "opacity-0"
      }`}
    >
      <main>
        <Navbar className="main-content bg-black text-white overflow-x-hidden w-full" />
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (testimonialScrollRef.current) {
                        testimonialScrollRef.current.scrollTo({
                          left:
                            testimonialScrollRef.current.clientWidth * index,
                          behavior: "smooth",
                        });
                      }
                    }}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-10">
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-4">
                ...
                <div className="flex items-center text-sm text-gray-300">
                  <FaCheckCircle className="mr-2 text-cyan-400" /> Instant
                  Access
                </div>
                <div className="flex items-center text-sm text-gray-300">
                  <FaLock className="mr-2 text-cyan-400" /> 30-Day Guarantee
